...
#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "M117 Command Executed"

  #define USER_DESC_1 "Auto Home"
  #define USER_GCODE_1 "G28 X0 Y0 \n G90 \n G0 X100 Y100 F3000 \n G28 Z0 \n"

  #define USER_DESC_2 "Auto Level"
  #define USER_GCODE_2 "G28 Z0 \n G29 P1 \n G29 T \n"

  #define USER_DESC_3 "Lower Plate"
  #define USER_GCODE_3 "G90 \n G0 X100 Y0 F3000 \n G0 Z170 F3000 \n"

  #define USER_DESC_4 "Preheat for PLA"
  #define USER_GCODE_4 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) " \n M104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)

  #define USER_DESC_5 "Preheat for NYLON"
