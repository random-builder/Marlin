...
#define STRING_CONFIG_H_AUTHOR "(random-builder, probe)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "WD6/probe"
...
#define DELAY_BEFORE_PROBING 125  // (ms) To prevent vibrations from triggering piezo sensors
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 10, 10, (Z_MIN_POS + 3)}
  #define NOZZLE_CLEAN_END_POINT   { 80, 40, (Z_MIN_POS + 3)}
